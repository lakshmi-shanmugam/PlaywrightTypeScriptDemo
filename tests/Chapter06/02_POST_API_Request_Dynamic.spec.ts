...
test('Create POST API Request using dynamic api request body in playwright & typescript', async ({ request }) => {
    ...
    console.log('POST API Response : - 02_POST_API_Request_Dynamic.spec.ts:34' + JSON.stringify(jsonPOSTAPIResponse, null, 2));
...
test('Create POST API Request using dynamic api request body in playwright & typescript 2', async ({ request }) => {
    ...
    // Print JSON API response
    const jsonPOSTAPIResponse = await postAPIResponse.json();
    console.log('POST API Response : - 02_POST_API_Request_Dynamic.spec.ts:80' + JSON.stringify(jsonPOSTAPIResponse, null, 2));
